        ...
        <div ref={componentRef} className="print-preview">
          ...
          <div className="notes-section">
            ...
            <div className="notes-content">
              1. Barang-barang di atas dikembalikan karena alasan yang
              disebutkan
              <br />
              2. Mohon periksa kembali kondisi barang yang dikembalikan
              <br />
              3. Pengembalian ini telah disetujui oleh pihak manajemen
              <br />
          ...
          <div className="signature-section">
            ...
            <div className="signature-box">
              ...
              <div className="signature-line"></div>
              <div className="signature-name">{data.supplier.nama}</div>
            </div>
          ...
          <div className="document-footer">
            Dokumen ini adalah bukti retur pembelian yang sah dan harus
