  ...
  return (
    <div className="print-container">
      <div ref={componentRef} className="print-preview">
        ...
        {/* Return Header */}
        <div className="retur-header" style={{ backgroundColor: '#d1ecf1', borderColor: '#bee5eb' }}>
          ...
          <div className="info-grid">
            ...
            <div className="info-row">
              ...
              <span className="info-value">
                {data.customer.tipePelanggan === 'retail' ? 'Retail' :
                 data.customer.tipePelanggan === 'wholesale' ? 'Wholesale' :
                 data.customer.tipePelanggan === 'distributor' ? 'Distributor' : '-'}
              </span>
            </div>
            <div className="info-row">
          ...
          <div className="document-info">
            <div className="info-grid">
              ...
              <div className="info-row">
                ...
                <span className="info-value">
                  {format(new Date(data.suratJalan.tanggal), 'dd MMMM yyyy', { locale: id })}
                </span>
              </div>
            </div>
          </div>
        ...
        <table className="data-table">
          ...
          <tfoot>
            <tr className="summary-row">
              <td colSpan={4} className="bold">TOTAL RETUR</td>
          ...
          <div className="info-grid">
            <div className="info-row">
              ...
              <span className="info-value text-success">
                {data.detail.filter(item => item.kondisi === 'bisa_dijual_lagi')
                  .reduce((sum, item) => sum + item.qty, 0)} {data.detail[0]?.barang.satuan}
              </span>
            </div>
            <div className="info-row">
              <span className="info-label">Barang Rusak Total:</span>
              <span className="info-value text-danger">
                {data.detail.filter(item => item.kondisi === 'rusak_total')
                  .reduce((sum, item) => sum + item.qty, 0)} {data.detail[0]?.barang.satuan}
              </span>
            </div>
          </div>
        ...
        <div className="document-footer">
          Dokumen ini adalah bukti retur penjualan yang sah dan harus ditandatangani oleh pihak terkait.
          <br />
